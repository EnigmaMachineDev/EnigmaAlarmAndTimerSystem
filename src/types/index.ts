...
// ─── Rule Alarm ──────────────────────────────────────────────────────────────
// Generated by the rules engine for each of the next 7 days.
// Regenerated fresh on every reschedule — not persisted long-term.
...
export interface ResolvedDayAlarm extends Alarm {
  sourceLayer: 'preset' | 'customization' | 'rule';
}
